...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['delete'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `students` WHERE id = '$uid') as `row_exists`  LIMIT 1";
        $result = $connect->query($sql);
...
<body>
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Student List</div>
                ...
                <section class="mt-2 px-2">
                    <div class="d-flex justify-content-end mb-4">
                        ...
                        <a href="addstudent.php"><span class="btn btn-primary me-1">
