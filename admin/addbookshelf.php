...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['add'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `departments` WHERE `name` = '$name' OR `department` = '$short') as `row_exists`  LIMIT 1";
        ...
        if($result->fetch_assoc()['row_exists'] == 0) {
            ...
            if($result) {
                ...
                header("Location: addbookshelf.php");
            } else {
...
<body>
                        ...
                        <div class="collapse" id="bookList">
                            <div>
                                <ul class="navbar-nav px-3">
                                    ...
                                    <li>
                                        <a class="nav-link active px-3" href="addbookshelf.php">
    ...
    <main class="mt-5 pt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Add Department</div>
                <!-- ./NOTIFICATION -->
                <?php
                if(isset($success)) {
                        ...
                        <form action="" method="post" class="row px-3">
                            <div class="mt-5">
                                <div class="col-md-10 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="ex: Computer Science & Engineering" required>
                                </div>
                                <div class="col-md-10 mb-2">
                                    <label for="short" class="form-label">Short Form</label>
                                    <input type="text" class="form-control" name="short" id="short" placeholder="ex: CSE" required>
                                </div>
                            </div>
                            <div class="mt-2">
                                <button name="add" type="submit" class="btn btn-primary text-uppercase">Add Department</button>
                            </div>
                        </form>
                    </div>
                </div>
