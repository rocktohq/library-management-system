...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['add'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `admins` WHERE `name` = '$name') as `row_exists`  LIMIT 1";
        $result = $connect->query($sql);
        ...
        if($result->fetch_assoc()['row_exists'] == 0) {
            ...
            $result = $connect->query($sql);
            if($result) {
                $_SESSION['success'] = "Librarian Added Successfully";
            ...
            $_SESSION['error'] = "Librarian Already Exists!";
                header("Location: addlibrarian.php");
        }
    }
...
<body>
    ...
    <main class="mt-5 pt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Add Librarian</div>
                <!-- ./NOTIFICATION -->
                <?php
                if(isset($success)) {
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="row px-3 addstudent">
                            <div class="mt-5">
                                ...
                                <div class="col-md-10 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="department" id="department" placeholder="ex: LMS" required>
                                </div>
                                <div class="col-md-10 mb-2">
                                    <label for="password" class="form-label">Password:</label>
                                    <input type="password" class="form-control" name="password" id="password" placeholder="Default: 12345" required>
                                </div>
                            </div>
                            <div class="mt-2">
