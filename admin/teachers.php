...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['delete'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `teachers` WHERE id = '$uid') as `row_exists`  LIMIT 1";
        $result = $connect->query($sql);

        if($result->fetch_assoc()['row_exists'] > 0) {
            $sql = "DELETE FROM `teachers` WHERE id = $uid";
            $result = $connect->query($sql);
            if($result) {
...
<body>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="teacherList">
                            <div>
                                <ul class="navbar-nav px-3">
                                    <li>
                                        <a class="nav-link active px-3" href="teachers.php">
                                            <span class="me-2"><i class="bi bi-list-columns-reverse"></i></span>
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Teachers List</div>
                <!-- ./NOTIFICATION -->
                <?php
                if(isset($success)) {
