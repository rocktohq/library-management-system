...
<body>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="requests">
                            <div>
                                ...
                                <ul class="navbar-nav px-3">
                                    <li>
                                        <a class="nav-link active px-3" href="return-requests.php">
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3 my-2">Return Requests</div>
                    ...
                    <div class="card text-dark bg-default h-100">
                        ...
                        <div class="card-body">
                            ...
                            $sql = "SELECT
                                    ...
                                    FROM
                                        returns
                                    INNER JOIN borrows ON returns.borrowed_by = borrows.borrowed_by AND borrows.confirmed = 1 AND borrows.returned = 0";
                            $result = $connect->query($sql);
                            if($result->num_rows) {
