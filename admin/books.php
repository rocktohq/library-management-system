...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['delete'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `books` WHERE id = '$uid') as `row_exists`  LIMIT 1";
        $result = $connect->query($sql);
...
<body>
                        ...
                        <div class="collapse" id="bookList">
                            <div>
                                <ul class="navbar-nav px-3">
                                    ...
                                    <li>
                                        <a class="nav-link active px-3" href="books.php">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDeleteLabel">Delete Book</h5>
    ...
    <div class="modal fade" id="modalUpdate" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalUpdateLabel">Update Book Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Form</p>
    ...
    <div class="modal fade" id="modalAdd" tabindex="-1" aria-labelledby="modalAddLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddLabel">Add New Book</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Form</p>
    ...
    <div class="modal fade" id="modalActivity" tabindex="-1" aria-labelledby="modalActivityLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta harum fuga ipsa consectetur tenetur repudiandae mollitia, tempore magni quos nesciunt a, nisi laboriosam! Ducimus soluta dolore eum adipisci, autem cum ab molestiae quasi
                        reiciendis dicta alias? Nisi, deserunt ducimus incidunt placeat quis, dolor numquam voluptatum delectus beatae, voluptatibus doloribus? Enim!</p>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta harum fuga ipsa consectetur tenetur repudiandae mollitia, tempore magni quos nesciunt a, nisi laboriosam! Ducimus soluta dolore eum adipisci, autem cum ab molestiae quasi
                        reiciendis dicta alias? Nisi, deserunt ducimus incidunt placeat quis, dolor numquam voluptatum delectus beatae, voluptatibus doloribus? Enim!</p>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta harum fuga ipsa consectetur tenetur repudiandae mollitia, tempore magni quos nesciunt a, nisi laboriosam! Ducimus soluta dolore eum adipisci, autem cum ab molestiae quasi
                        reiciendis dicta alias? Nisi, deserunt ducimus incidunt placeat quis, dolor numquam voluptatum delectus beatae, voluptatibus doloribus? Enim!</p>
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Book List</div>
                <!-- ./NOTIFICATION -->
                <?php
                if(isset($success)) {
                ...
                <section class="mt-2 px-2">
                    <div class="d-flex justify-content-end mb-4">
                        ...
                        <a href="addbook.php"><span class="btn btn-primary me-1">
