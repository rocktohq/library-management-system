...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['add'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `students` WHERE `uid` = '$suid') as `row_exists`  LIMIT 1";
        $result = $connect->query($sql);
...
<body>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="studentList">
                            <div>
                                <ul class="navbar-nav px-3">
                                    <li>
                                        <a class="nav-link active px-3" href="students.php">
                                            <span class="me-2"><i class="bi bi-list-columns-reverse"></i></span>
    ...
    <main class="mt-5 pt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Add Student</div>
                <!-- ./NOTIFICATION -->
                <?php
                if(isset($success)) {
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="row px-3 addstudent">
                            <div class="mt-5">
                                ...
                                <div class="col-md-10 mb-2">
                                    ...
                                    <input type="number" class="form-control" name="suid" id="suid" placeholder="Student ID" required>
                                </div>
                                <div class="col-md-10 mb-2">
                                ...
                                <div class="col-md-10 mb-2">
                                    ...
                                    <input type="number" class="form-control" name="batch" id="batch" placeholder="Batch" required>
                                </div>
                                <div class="col-md-10 mb-2">
                                    <label for="session" class="form-label">Admission Session:</label>
                                    <input type="text" class="form-control" name="session" id="session" placeholder="ex: Winter 2022" required>
                                </div>
                                <div class="col-md-10 mb-2">
