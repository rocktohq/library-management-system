...
if(isset($_COOKIE['lmsadmin'])) {
    ...
    if(isset($_POST['add'])) {
        ...
        $sql = "SELECT EXISTS (SELECT * FROM `books` WHERE `book_code` = '$book_code') as `row_exists`  LIMIT 1";
        $result = $connect->query($sql);
...
<body>
                        ...
                        <div class="collapse" id="bookList">
                            <div>
                                <ul class="navbar-nav px-3">
                                    ...
                                    <li>
                                        <a class="nav-link active px-3" href="addbook.php">
                                            <span class="me-2"><i class="bi bi-plus-square"></i></span>
                                            <span>Add Book</span>
                                        </a>
                                    </li>
    ...
    <main class="mt-5 pt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 fw-bold fs-3">Add Book</div>
                <!-- ./NOTIFICATION -->
                <?php
                if(isset($success)) {
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="row px-3">
                            <div class="mt-5">
                                ...
                                <div class="col-md-10 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="book_code" id="book_code" placeholder="Book Code" required>
                                </div>
                                <div class="col-md-10 mb-2">
                                ...
                                <div class="col-md-10 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="book_author" id="book_author" placeholder="Book Author" required>
                                </div>
                                <div class="col-md-10 mb-2">
                            ...
                            <div class="mt-2">
                                <button name="add" type="submit" class="btn btn-primary text-uppercase">Add Book</button>
                            </div>
                        </form>
                    </div>
                </div>
